...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('kitchen_sink_page', 'template_id')


        # Changing field 'Page.tpl'
        db.alter_column('kitchen_sink_page', 'tpl', self.gf('django.db.models.fields.CharField')(default='home.html', max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.tpl'
        db.alter_column('kitchen_sink_page', 'tpl', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
