...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blurb.etype'
        db.add_column('kitchen_sink_blurb', 'etype',
                      self.gf('django.db.models.fields.CharField')(default='rich', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blurb.etype'
        db.delete_column('kitchen_sink_blurb', 'etype')
