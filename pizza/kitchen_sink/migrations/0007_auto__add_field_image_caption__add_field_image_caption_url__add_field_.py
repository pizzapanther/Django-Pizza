...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kitchen_sink_image', 'caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.caption_url'
        db.add_column('kitchen_sink_image', 'caption_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.credit'
        db.add_column('kitchen_sink_image', 'credit',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.credit_url'
        db.add_column('kitchen_sink_image', 'credit_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('kitchen_sink_image', 'caption')

        # Deleting field 'Image.caption_url'
        db.delete_column('kitchen_sink_image', 'caption_url')

        # Deleting field 'Image.credit'
        db.delete_column('kitchen_sink_image', 'credit')

        # Deleting field 'Image.credit_url'
        db.delete_column('kitchen_sink_image', 'credit_url')
