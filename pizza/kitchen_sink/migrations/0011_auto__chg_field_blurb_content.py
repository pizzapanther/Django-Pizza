...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blurb.content'
        db.alter_column('kitchen_sink_blurb', 'content', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Blurb.content'
        raise RuntimeError("Cannot reverse this migration. 'Blurb.content' and its values cannot be restored.")
