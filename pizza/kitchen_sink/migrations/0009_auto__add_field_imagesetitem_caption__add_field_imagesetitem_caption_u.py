...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageSetItem.caption'
        db.add_column('kitchen_sink_imagesetitem', 'caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageSetItem.caption_url'
        db.add_column('kitchen_sink_imagesetitem', 'caption_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageSetItem.credit'
        db.add_column('kitchen_sink_imagesetitem', 'credit',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageSetItem.credit_url'
        db.add_column('kitchen_sink_imagesetitem', 'credit_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageSetItem.caption'
        db.delete_column('kitchen_sink_imagesetitem', 'caption')

        # Deleting field 'ImageSetItem.caption_url'
        db.delete_column('kitchen_sink_imagesetitem', 'caption_url')

        # Deleting field 'ImageSetItem.credit'
        db.delete_column('kitchen_sink_imagesetitem', 'credit')

        # Deleting field 'ImageSetItem.credit_url'
        db.delete_column('kitchen_sink_imagesetitem', 'credit_url')
