...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'File.modified'
        db.delete_column('kitchen_sink_file', 'modified')

        # Deleting field 'File.added_by'
        db.delete_column('kitchen_sink_file', 'added_by_id')

        # Deleting field 'Image.modified'
        db.delete_column('kitchen_sink_image', 'modified')

        # Deleting field 'Image.added_by'
        db.delete_column('kitchen_sink_image', 'added_by_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'File.modified'
        raise RuntimeError("Cannot reverse this migration. 'File.modified' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'File.added_by'
        raise RuntimeError("Cannot reverse this migration. 'File.added_by' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'Image.added_by'
        raise RuntimeError("Cannot reverse this migration. 'Image.added_by' and its values cannot be restored.")
